    ...
    public void gameOfLife2(int[][] board) {
        for (int i = 0; i < board.length; i++) {
            for (int j = 0; j < board[0].length; j++) {
                ...
                if (board[i][j] == 1 && count_neighbor < 2) {
                    board[i][j] = -1;
                } else if (board[i][j] == 1 && count_neighbor >= 4) {
                    board[i][j] = -1;
                } else if (board[i][j] == 1 && (count_neighbor == 2 || count_neighbor == 3)) {
                    board[i][j] = 1;
                } else if (board[i][j] == -1 && count_neighbor == 3) {
                    board[i][j] = 2;
                }
            }
        }
